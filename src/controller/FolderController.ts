...
export const listFolders = async (request: Request, response: Response) => {
...
export const saveFolder = async (request: Request, response: Response) => {
...
export const removeFolder = async (request: Request, response: Response) => {
    const { id } = request.params;
