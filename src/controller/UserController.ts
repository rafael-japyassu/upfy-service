...
export const listUser = async (request: Request, response: Response): Promise<Response<any>> => {
  try {
...
export const findUser = async (request: Request, response: Response): Promise<Response<any>> => {
